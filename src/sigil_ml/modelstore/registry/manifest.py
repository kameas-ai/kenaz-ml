...
def local_feature_contract(model_name: str) -> FeatureContract | None:
    ...
    ``sigil_ml.feature_store.definitions``, whose schema is itself built by
    ...
    ``service_version`` is
    :func:`sigil_ml.feature_store.materialize.feature_service_version` — a hash
        ...
        return ValidationOutcome(
            refusal=Refusal(
                ...
                (
                    ...
                    "sigil_ml.feature_store.definitions.FEATURE_SERVICES declares its contract"
                ),
            )
        )
