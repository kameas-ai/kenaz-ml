...
if TYPE_CHECKING:  # pragma: no cover - typing only
    from sigil_ml.modelstore.registry import AppendResult, FeatureContract, Provenance
...
def _next_provenance(directory: Path, model_name: str, training_source: str) -> Provenance:
    ...
    """
    from sigil_ml import config
    from sigil_ml.modelstore.registry import Provenance, read_manifest
...
def _retain_examples(
    ...
    from sigil_ml.modelstore.registry import Example, append_examples
